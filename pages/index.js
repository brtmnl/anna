            ...
            <div className="proj_div" key={idx}>
              ...
              <Link href={'/'+proj.url}>
                <a className="proj_desc py-3">
                  <p className="proj_name ml-3">{proj.name}  <svg data-testid="geist-icon" fill="none" height="41" shapeRendering="geometricPrecision" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 25 27" width="50"><path d="M13 17l5-5-5-5"></path><path d="M6 17l5-5-5-5"></path></svg></p>
